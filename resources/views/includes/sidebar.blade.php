<div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
    <nav class="pt-4">
        ...
        <a href='/api/wishes/create' class="flex items-center py-2 hover:text-blue-600 text-sm">
        ...
        <a href="/" class="flex items-center py-2 hover:text-blue-600 text-sm">
           
            <p class="tracking-wide pl-3 ">Wishes</p>
        </a>
