<template>
    <div>   
      <form @submit.prevent="submitForm">
          <InputField name="name" label="Name of your wish" placeholder="Life" @update:field="form.name=$event"/>

          <InputField name="wish" label="What do you wish for?" placeholder="" @update:field="form.wish=$event"/>
