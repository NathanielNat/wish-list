    ...
    <div class="h-screen bg-white ">
        <div class="flex">
            <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
                <nav class="pt-4">
                    <!-- router link links to the link in the link -->
                    <router-link to="/" class="flex items-center py-2">
                        <h1 class="text-teal-600 text-uppercase font-bold"> wish list</h1>
                    </router-link>


                    <p class="pt-12 text-gray-500 text-xs uppercase font-bold">Create</p>
                    <router-link to='/wishes/create' class="flex items-center py-2 hover:text-blue-600 text-sm">
                        <svg viewBox="0 0 24 24" class="fill-current text-teal-600 w-5 h-5">
                            <path
                        ...
                        <p class="tracking-wide pl-3 ">Make a Wish </p>
                    </router-link>

                    <p class="pt-12 text-gray-500 text-xs uppercase font-bold">General</p>
                    <router-link to="/wishes" class="flex items-center py-2 hover:text-teal-600 text-sm">
                        
                        <p class="tracking-wide pl-3 ">Wish List</p>
                    </router-link>
